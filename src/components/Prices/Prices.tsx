...
const Prices: FC = () => {
  ...
  return (
    <section>
      ...
      <div>
        <Slider {...settings}>
          <div className="!flex flex-col  items-center w-[357px] h-[831px] mx-[32px] pt-[30px] px-[24px] pb-[40px]">
            ...
            <h3 className="mb-[12px] text-xl text-center font-semibold">Індивідуальні заняття1</h3>
            <p className="mb-[6px] text-base text-center font-semibold">4 заняття в місяць</p>
            <p className="mb-[6px] text-base text-center">(Якщо ну зовсім мало вільного часу)</p>
            </div>
            <ul className="flex flex-col gap-2.5 list-disc">
              <li className="text-base">Зручні дні і час</li>
              ...
              <li>доступ до каналу з щоденною порцією корисної англійської</li>
              <li>доступ до каналу з щоденною порцією корисної англійської</li>
